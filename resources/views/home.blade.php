...
@section('content')
  ...
  <section class="body-section">
    <!-- <div class="body-header">
      ...
      <p class="title-desc">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Pariatur repudiandae veritatis non ipsa ex mollitia ad at veniam, in atque labore. Velit quisquam ducimus consectetur cumque eaque, quis maxime culpa!</p>
    </div> -->
